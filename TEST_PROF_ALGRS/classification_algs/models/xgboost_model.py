...
def train(df, target, params: dict = None):
    ...
    logger.info("=== Запуск функції train (XGBClassifier) ===")
    ...
    default_params = {
        ...
        "gamma": 0,
        "eval_metric": "mlogloss",   # багатокласова класифікація
        "random_state": 42,
        "test_split": 0.2
    }
    ...
    logger.info("Модель XGBClassifier створена")
    ...
    logger.info("=== Кінець функції train (XGBClassifier) ===")
