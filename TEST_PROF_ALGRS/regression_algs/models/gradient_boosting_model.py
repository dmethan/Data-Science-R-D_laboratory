...
def train(df, target, params: dict = None):
    """
    Тренування моделі GradientBoostingRegressor.
    Параметри приймаються через словник params.
    """

    logger.info("=== Запуск функції train (GradientBoostingRegressor) ===")
    ...
    logger.info("Модель GradientBoostingRegressor створена")
    ...
    logger.info("=== Кінець функції train (GradientBoostingRegressor) ===")
