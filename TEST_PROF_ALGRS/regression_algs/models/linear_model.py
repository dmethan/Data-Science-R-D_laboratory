...
def train(df, target, params: dict = None):
    ...
    logger.info("=== Запуск функції train (LinearRegression) ===")
    ...
    logger.info("Модель LinearRegression створена")
    ...
    save_model(model_package, "linear_regression_model")
    logger.info("Модель збережена у файл linear_regression_model.pkl")

    logger.info("=== Кінець функції train (LinearRegression) ===")
