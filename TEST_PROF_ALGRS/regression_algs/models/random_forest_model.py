...
def train(df, target, params: dict = None):
    """
    Тренування моделі RandomForestRegressor.
    Параметри приймаються через словник params.
    """

    logger.info("=== Запуск функції train (RandomForestRegressor) ===")
    ...
    logger.info("Модель RandomForestRegressor створена")
    ...
    logger.info("=== Кінець функції train (RandomForestRegressor) ===")
